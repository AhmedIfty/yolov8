...
# ======= DEFAULTS (edit these to change the out-of-the-box run) =======
DEFAULTS = {
...
def main():
    ...
    print("[CONFIG] Using:",
          ...
          f"\n  input={args.input}",
          f"\n  query='{args.query}'",
          # f"\n  temp={args.temp} perc_q={args.perc_q} neg_beta={args.neg_beta} thr={args.thr} delta={args.delta}",
          # f"\n  fuse_thr={args.fuse_thr} pad={args.pad} dump_crops={args.dump_crops} stage={args.dump_stage}",
          f"\n  out={args.out}")
...
# python bqa/bqa_rerank_v11.py --weights weights/yolov8m_refined_v4_baseline.pt --input bqa/bqa_test --query "syringe" --fuse_thr 0.45 --temp 0.05 --perc_q 90 --thr 0.20 --delta 0.08 --neg_beta 0.30 --dump_crops 1 --dump_stage postgate
